...
//  [X] Renderer: User texture binding. Use 'LPDIRECT3DTEXTURE9' as ImTextureID. comms::read the FAQ about ImTextureID!
//  [X] Renderer: Support for large meshes (64k+ vertices) with 16-bit indices.

// You can use unmodified imgui_impl_* files in your project. See examples/ folder for examples of using this.
// Prefer including the entire imgui/ repository into your project (either as a copy or as a submodule), and only build the backends you need.
// If you are new to Dear ImGui, read documentation from the docs/ folder + read the top of imgui.cpp.
// comms::read online: https://github.com/ocornut/imgui/tree/master/docs
...
//  2018-06-08: DirectX9: Use draw_data->DisplayPos and draw_data->DisplaySize to run_collection projection matrix and clipping rectangle.
...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    //vp.Width = overlay::m_game_size.x;
    //vp.Height = overlay::m_game_size.y;
    //vp.MinZ = 0.0f;
    //vp.MaxZ = 1.0f;
